...
describe('Branding', { testIsolation: 'off' }, () => {
  ...
  it('[Vue3 Skip]: Logo', { tags: ['@globalSettings', '@adminUser'] }, () => {
  ...
  it('[Vue3 Skip]: Banner', { tags: ['@globalSettings', '@adminUser'] }, () => {
    const prefPage = new PreferencesPagePo();
  ...
  it('[Vue3 Skip]: Login Background', { tags: ['@globalSettings', '@adminUser'] }, () => {
    const prefPage = new PreferencesPagePo();
