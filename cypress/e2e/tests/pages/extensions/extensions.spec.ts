...
describe('Extensions page', { tags: ['@extensions', '@adminUser'] }, () => {
  ...
  it('[Vue3 Skip]: Should install an extension', () => {
    const extensionsPo = new ExtensionsPagePo();
  ...
  it('[Vue3 Skip]: Should not display installed extensions within the available tab', () => {
    const extensionsPo = new ExtensionsPagePo();
  ...
  it('[Vue3 Skip]: Should update an extension version', () => {
    const extensionsPo = new ExtensionsPagePo();
  ...
  it('[Vue3 Skip]: Should rollback an extension version', () => {
    const extensionsPo = new ExtensionsPagePo();
  ...
  it('[Vue3 Skip]: An extension larger than 20mb, which will trigger chacheState disabled, should install and work fine', () => {
    const extensionsPo = new ExtensionsPagePo();
  ...
  it('[Vue3 Skip]: Should respect authentication when importing extension scripts', () => {
    const extensionsPo = new ExtensionsPagePo();
  ...
  it('[Vue3 Skip]: Should uninstall extensions', () => {
  ...
  it('[Vue3 Skip]: Should uninstall unathenticated extensions', () => {
    // Because we logged out in the previous test this one will also have to use an uncached login
    cy.login(undefined, undefined, false);
    const extensionsPo = new ExtensionsPagePo();
  ...
  it('[Vue3 Skip]: Should uninstall un-cached extensions', () => {
    // Because we logged out in the previous test this one will also have to use an uncached login
    cy.login(undefined, undefined, false);
    const extensionsPo = new ExtensionsPagePo();
